...
* `host` - Represents the name of the Undertow host that the LRA Coordinator is deployed to.

* `server` - Represents the name of the Undertow server that the LRA Coordinator is deployed to.
...
* `proxy-host` - Represents the name of the Undertow host that the LRA Participant proxy deploys to.

* `proxy-server` - Represents the name of the Undertow server that the LRA Participant proxy deploys to.
