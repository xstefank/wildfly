...
public class MicroProfileLRACoordinatorExtension implements Extension {
    ...
    public static final ServiceName LRA_COORDINATOR = LRA.append("coordinator");
    public static final ServiceName LRA_RECOVERY_SERVICE = LRA.append("recovery-service");
    ...
    private String CURRENT_NAMESPACE_URI = LRA_COORDINATOR_1_0_NAMESPACE_URI;
