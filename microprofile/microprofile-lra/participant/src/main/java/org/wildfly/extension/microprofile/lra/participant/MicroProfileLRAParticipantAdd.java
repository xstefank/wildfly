...
class MicroProfileLRAParticipantAdd extends AbstractBoottimeAddStepHandler {
    ...
    protected void populateModel(ModelNode operation, ModelNode model) throws OperationFailedException {
        ...
        MicroProfileLRAParticipantSubsystemDefinition.LRA_COORDINATOR_URL.validateAndSet(operation, model);
        MicroProfileLRAParticipantSubsystemDefinition.PROXY_SERVER.validateAndSet(operation, model);
        MicroProfileLRAParticipantSubsystemDefinition.PROXY_HOST.validateAndSet(operation, model);
    }
