...
//        initialParameters.put("resteasy.injector.factory", "org.jboss.resteasy.cdi.CdiInjectorFactory");
        ...
        System.setProperty("different.path.for.participant.resource", "http://localhost:8080/lra-participant-narayana-proxy");
    }
